...
//active class
  $('#navlist a , .pagination a').click(function(e) {
    e.preventDefault(); //prevent the link from being followed
    $('#navlist a, .pagination a').removeClass('selected');
...
$('ul.expandible').each(function(){
    ...
    if($lis.length > 0){
        $ul
            .append($('<li class="expand"><span>' + (isExpanded ? 'Show Less' : 'Load More') + '</span></li>')
